package com.example.serenodd;

import com.example.serenodd.media.Media;
import com.example.serenodd.media.MediaRepository;
import com.example.serenodd.media.Type;
...
public class SerenoddApplication {

    public static void main(String[] args) {
        SpringApplication.run(SerenoddApplication.class, args);
    }
    ...
    CommandLineRunner commandLineRunner(MediaRepository mediaRepository) {
        return args -> {
            ...
            Media media11 = new Media(
                    ...
                    "Misusing Exceptions in Code and Life.",
                    null,
                    null,
                    Type.PODCAST);
            ...
            Media media14 = new Media(
                    ...
                    null,
                    Type.PODCAST);
            System.out.println("added seed data");
            mediaRepository.saveAll(List.of(media1, media2, media3, media4, media5, media6, media7, media8, media9, media10, media11, media12, media13, media14));


            //TESTS
//            System.out.println(mediaRepository.count());
//
//            mediaRepository.findById(8L).ifPresentOrElse(media -> {
//                System.out.println(media);
//            }, () -> {
//                System.out.println("Media with ID 8 not found");
//            });
//
//            mediaRepository.findById(13L).ifPresentOrElse(media -> {
//                System.out.println(media);
//            }, () -> {
//                System.out.println("Media with ID 13 not found");
//            });
//
...
//            mediaRepository
//                    .findMediaByTitle("The Pragmatic Programmers")
//                    .ifPresentOrElse(System.out::println, () -> System.out.println("Media with title \"The Pragmatic Programmers\" not found."));
//
//            mediaRepository.findMediaByNameEqualsAndTitleEquals(
//                    "Javascript Jabber",
//                    "The Things Every JavaScript Developer Must Know, Part 2"
//            ).forEach(System.out::println);
//
//            System.out.println(mediaRepository.deleteMediaById(3L));
//
//            System.out.println(mediaRepository.updateName(
//                    "Tiffany was here",
//                    1L
//            ));

//                        System.out.println(mediaRepository.updateDescription(
//                    "Tiffany was here",
//                    1L
//            ));
